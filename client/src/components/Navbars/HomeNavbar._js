        ...
        <Container>
          <UncontrolledDropdown className="button-dropdown">
            ...
            <DropdownMenu aria-labelledby="navbarDropdown">
              ...
              <DropdownItem href="/home-page" onClick={e => e.preventDefault()}>
              <Link to="/home-page" className="nav-link">
                    Home
                </Link>
              </DropdownItem>
              <DropdownItem href="/signup" onClick={e => e.preventDefault()}>
              <Link to="/signup" className="nav-link">
                        Signup
                    </Link>
              </DropdownItem>
              <DropdownItem href="/signin" onClick={e => e.preventDefault()}>
